...
HEADLINE_STYLE_USER_LINE=$bold$cyan
HEADLINE_STYLE_PATH=$bold$magenta
HEADLINE_STYLE_PATH_LINE=$bold$magenta
HEADLINE_STYLE_BRANCH=$bold$red
HEADLINE_STYLE_BRANCH_LINE=$bold$red
HEADLINE_STYLE_STATUS=$bold$yellow
HEADLINE_STYLE_STATUS_LINE=$bold$yellow
HEADLINE_HOST_CMD=""
